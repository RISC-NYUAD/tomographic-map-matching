...
room_ids = ["00", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10"]
...
def main():
    ...
    for outer_prod in itertools.product(grid_sizes, noise_levels):
        ...
        for inner_prod in itertools.product(room_ids, trajectory_pairs):
            ...
            pair = [
                f"kitti{room_id}-g{grid_size}-traj{trajectory_pair[0]}-n{noise_level}.pcd",
                f"kitti{room_id}-g{grid_size}-traj{trajectory_pair[1]}-n{noise_level}.pcd",
            ]
            pairs.append(pair)
